...
%opening
\def\ThesisTitle{Evaluierung und Anwendung moderner Designprozesse bei der Startup-Gründung}
\def\ThesisAuthor{Verena Schmöller}
\def\ThesisLocation{Regensburg}
\def\ThesisType{Bachelor}
\def\CourseType{B.Sc. Technische Informatik}
\def\ThesisPubDate{\today} % Change here to the date you are going to print your thesis
\def\ThesisFirstSupervisor{Prof. Dr. Markus Heckner}
\def\ThesisSecondSupervisor{???}
\def\ThesisSubject{}
